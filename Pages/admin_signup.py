        ...
        with ui.column().classes("w-full p-8 gap-4"):
            ...
            with ui.row().classes("w-full grid grid-cols-3 gap-2 mb-4"):
                ...
                with ui.column().on(
                    ...
                    ui.icon("support_agent").classes("text-3xl mb-1 text-gray-400 group-hover:text-black")
                ...
                with ui.column().classes(
                    "items-center justify-center p-3 border-2 rounded-lg cursor-pointer bg-black text-white border-black transition-all"
                ):
